...
import { kadenaCheckMnemonic, kadenaGenKeypair, kadenaGenMnemonic, kadenaMnemonicToRootKeypair, kadenaSign, kadenaSignFromRootKey, } from '../index.js';
...
describe('kadenaMnemonicToRootKeypair', () => {
    ...
    it('should generate different root key for different mnemonic', async () => {
        ...
        const rootKey1 = await kadenaMnemonicToRootKeypair(PASSWORD, MNEMONIC);
        const rootKey2 = await kadenaMnemonicToRootKeypair(PASSWORD, mnemonicSecond);
...
describe('kadenaGenKeypair', () => {
    it('should generate keyPair from the rootKey', async () => {
        const rootKey = await kadenaMnemonicToRootKeypair(PASSWORD, MNEMONIC);
        const { publicKey, secretKey } = await kadenaGenKeypair(PASSWORD, rootKey, 1);
    ...
    it('should generate a valid signature', async () => {
        ...
        const signature = await kadenaSignFromRootKey(PASSWORD, base64hash, rootKey, 1);
        expect(signature).toBeTruthy();
        expect(Buffer.from(signature).toString('hex')).toBe('bedd0722d330f063266b4b72b2987856c9c7bc0f5f894eb490541441c59bf4c21dba3d35e5214050c90e727b16617c885cb74b2d3fbcd0ebb723f524c8679805');
    });
