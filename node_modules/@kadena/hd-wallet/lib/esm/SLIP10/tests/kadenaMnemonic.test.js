...
describe('kadenaMnemonicToSeed', () => {
    ...
    it('should throw an error for an invalid mnemonic', async () => {
        ...
        await expect(kadenaMnemonicToSeed('password', invalidMnemonic)).rejects.toThrowError('Invalid mnemonic.');
    });
    it('should throw an error when mnemonic is empty', async () => {
        const emptyMnemonic = '';
        await expect(kadenaMnemonicToSeed('password', emptyMnemonic)).rejects.toThrowError('Invalid mnemonic.');
    });
});
