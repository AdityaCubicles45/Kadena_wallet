 ...
 * @public
 */
export function kadenaGenMnemonic() {
 ...
 * @public
 */
export async function kadenaMnemonicToSeed(password, mnemonic, encode = 'base64') {
...
**/
export const kadenaEntropyToMnemonic = (entropy) => bip39.entropyToMnemonic(entropy, wordlist);
