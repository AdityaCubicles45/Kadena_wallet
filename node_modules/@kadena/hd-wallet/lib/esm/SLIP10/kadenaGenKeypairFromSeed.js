...
async function genKeypairFromSeed(password, seedBuffer, index, derivationPathTemplate) {
    ...
    const encryptedPrivateKey = await kadenaEncrypt(password, Buffer.from(privateKey, 'hex'));
 ...
 */
export async function kadenaGenKeypairFromSeed(password, seed, indexOrRange, derivationPathTemplate = `m'/44'/626'/<index>'`) {
